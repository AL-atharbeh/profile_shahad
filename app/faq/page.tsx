            ...
            <section className="py-20 md:py-32 bg-gray-50 overflow-hidden relative" ref={contactReveal.ref}>
                <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <a href="tel:0000" className={`p-10 rounded-[2.5rem] bg-white border border-emerald-100 shadow-premium flex flex-col items-center group hover:-translate-y-2 transition-all duration-700 ${contactReveal.isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '200ms' }}>
                            ...
                            <span className="text-emerald-800/60 font-bold">+965 2222 0000</span>
                        </a>
                        <a href="mailto:help@shahd.com" className={`p-10 rounded-[2.5rem] bg-white border border-emerald-100 shadow-premium flex flex-col items-center group hover:-translate-y-2 transition-all duration-700 ${contactReveal.isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{ animationDelay: '400ms' }}>
                            <div className="w-16 h-16 rounded-2xl bg-emerald-600 text-white flex items-center justify-center mb-6 shadow-glow group-hover:scale-110 transition-transform">
                            ...
                            <span className="text-emerald-800/60 font-bold">help@shahd.com</span>
                        </a>
                    </div>
                </div>
            </section>
