          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            >
              <div className="flex flex-col gap-1.5 items-center justify-center w-6">
                <span className={`block h-0.5 bg-[#4d6528] rounded-full transition-all duration-300 ${isMenuOpen ? 'w-6 rotate-45 translate-y-2' : 'w-6'}`}></span>
                <span className={`block h-0.5 bg-[#4d6528] rounded-full transition-all duration-300 ${isMenuOpen ? 'w-0 opacity-0' : 'w-4 ml-auto'}`}></span>
                <span className={`block h-0.5 bg-[#4d6528] rounded-full transition-all duration-300 ${isMenuOpen ? 'w-6 -rotate-45 -translate-y-2' : 'w-6'}`}></span>
              </div>
            </button>
