            ...
            <div className="flex flex-col gap-3">
              ...
              {[
                ...
                <Link
                  key={i}
                  href={link.href}
                  className="text-emerald-800/50 hover:text-emerald-700 transition-colors text-sm font-ibm-plex-arabic cursor-pointer"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-xl bg-emerald-50 hover:bg-emerald-100 flex items-center justify-center text-emerald-700 hover:text-emerald-600 transition-all duration-300 cursor-pointer"
